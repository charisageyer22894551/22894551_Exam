...
\section{Plot 1: Top production
countries}\label{plot-1-top-production-countries}
...
\newpage \# Genre popularity The most common movie genres by movie
production count are drama and comedy, followed by thriller and action.
This says nothing about the quality of movies or if th emovies were
popular and successful.
\includegraphics{Question3_files/figure-latex/unnamed-chunk-2-1.pdf} \#
Genre ratings of top countries The genres with the highest average
rating overall is documentary and history. This is not significantly
higher than many other genres, often only being 0.1 points above
another, ona scale of 1-10.
