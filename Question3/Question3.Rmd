...
\newpage
# Genre popularity
The most common movie genres by movie production count are drama and comedy, followed by thriller and action. This says nothing about the quality of movies or if the movies were popular and successful. 
```{r fig.align = 'center', fig.pos = "H", out.width = "80%"}
...
As we can see in the scatterplot, the movies with the highest ratings (above the 7.5 threshold), are of various lengths. However, it remains bundled between 60 and 120 minutes. Preference for movies around 100 minutes remain evidenent. 
```{r fig.align = 'center', fig.pos = "H", out.width = "80%"}
