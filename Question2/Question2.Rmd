...
# Let's name the columns consistently

metallica <- metallica %>% rename(album = album, 
                                  song = name, 
                                  year = year)
coldplay <- coldplay %>% rename(album = album_name, 
                                  song = name, 
                                  year = year)
...
# Popularity by album, arranged by release date
```{r}
q <-  ggplot(coldplay, aes(x = fct_reorder(album, popularity, .fun = median), y = popularity, fill = album)) +
