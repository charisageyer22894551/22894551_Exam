...
# Plot 1
We observe the popularity of names for oys and girls over time. By looking at the colour-coordinated bubbles, we observe persistence in the naming of very popular names like "Mary" and "James" - the two most popular names overall. 
```{r, fig.align= 'center'}
...
```
\newpage
# Plot 2: Increase in name popularity year-on-year, per decade: Girls
...
```
\newpage
# Plot 3: Increase in name popularity year-on-year, per decade: Boys
These plots show how year-on-year popularity of names are distributed. The 3 names that had the highest uptake per decade is shown in red. This can be compared to releases of music. movies where the name is used. 
