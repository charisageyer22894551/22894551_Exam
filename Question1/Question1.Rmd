...
# Plot 1: Popular names by decade: Girls
...
# Plot 2: Popular names by decade: Boys
```{r}
...
# Plot 3: Increase in name popularity year-on-year, per decade: Girls
```{r}
q <- top25_increaseplot(Baby_Names)
q
```

# Plot 4: Increase in name popularity year-on-year, per decade: Boys
```{r}
...
<!-- ```{r} -->
<!-- top25_girlscharactersplot <- top25_plot(df = HBO_characters_MF, xaxis_size = 10, xaxis_rows = 2, gender_filter = "F") -->
<!-- top25_girlsplot -->

<!-- top25_boycharactersplot <- top25_plot(df = HBO_characters_MF, xaxis_size = 10, xaxis_rows = 2, gender_filter = "M") -->
<!-- top25_boysplot -->
<!-- ``` -->


<!-- top25_actor_plot <- top25_actor_plot(df = HBO_MF, xaxis_size = 10, xaxis_rows = 2, gender_filter = "F", name_col = ) -->
...
\newpage
# Comparison with Movie Characters

```{r}
# #girls
# girlmatches <- findmatches(Baby_Names)
# 
# #boys
# 
# boymatches <- findmatches(Baby_Names, gender_filter = "M")
# 
# actor_matches <- results$actors
# character_matches <- results$characters
# 
...
```
Of the top 25 girl and boy names in the list of baby names, ()% of them are correlated to a popular character or actor in the same decade. 
